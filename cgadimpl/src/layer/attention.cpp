...
Attention::Attention(int batch, int in_features, int out_features, int H, Device dev) {
    ...
    Tensor wq = OwnTensor::Tensor::randn(Shape{{out_features, out_features}}, param_opts) ;
    Tensor wk = OwnTensor::Tensor::randn(Shape{{out_features, out_features}}, param_opts) ;
    Tensor wv = OwnTensor::Tensor::randn(Shape{{out_features, out_features}}, param_opts) ;
