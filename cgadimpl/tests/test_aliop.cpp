...
//             Tensor we_tensor = OwnTensor::Tensor::randn(Shape{{hidden_features, out_features}}, TensorOptions().with_device(Device::CUDA)) *sqrtf(0.002f / D);
//     Tensor be_tensor = OwnTensor::Tensor::zeros(Shape{{1, hidden_features}}, TensorOptions().with_device(Device::CUDA));
//     Tensor wae_tensor = OwnTensor::Tensor::randn(Shape{{hidden_features, out_features}}, TensorOptions().with_device(Device::CUDA)) *sqrtf(0.002f  / D);
//     Tensor bae_tensor = OwnTensor::Tensor::zeros(Shape{{1, hidden_features}}, TensorOptions().with_device(Device::CUDA));
//     Tensor wce_tensor = OwnTensor::Tensor::randn(Shape{{out_features, hidden_features}}, TensorOptions().with_device(Device::CUDA)) *sqrtf(0.002f / D);
//     Tensor bce_tensor = OwnTensor::Tensor::zeros(Shape{{1, out_features}}, TensorOptions().with_device(Device::CUDA));
...
//         Tensor wde_tensor = OwnTensor::Tensor::randn(Shape{{out_features, out_features}}, TensorOptions().with_device(Device::CUDA));
//     Tensor bde_tensor = OwnTensor::Tensor::zeros(Shape{{1, out_features}}, TensorOptions().with_device(Device::CUDA));
