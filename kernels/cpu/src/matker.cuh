...
void run_cuda_gcu(const float*, float*, int);
void run_cuda_mish(const float*, float*, int);
void run_cuda_gaus(const float*, float*, int);
void run_cuda_parcon(const float*, float*, int);
void run_cuda_lisht(const float*, float*, int);
void run_cuda_softplus(const float*, float*, int);
void run_cuda_silu(const float*, float*, int);
